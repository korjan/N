...
var __route_blog_json = /*#__PURE__*/Object.freeze({
	get: get
});
...
var __route_blog_$slug_json = /*#__PURE__*/Object.freeze({
	get: get$1
});

var Index = {};

Index.filename = "/Users/korjanvanwieringen/Documents/GitHub/N/src/routes/index.html";
...
Index._render = function(__result, ctx, options) {
	...
	return `${(__result.head += `<title>Sapper project template</title>`, "")}
...
About._render = function(__result, ctx, options) {
	...
	return `${(__result.head += `<title>About</title>`, "")}
...
Index$1.filename = "/Users/korjanvanwieringen/Documents/GitHub/N/src/routes/blog/index.html";

Index$1.data = function() {
	return {};
};

Index$1.render = function(state, options = {}) {
	var components = new Set();
	...
	var result = { head: '', addComponent };
	var html = Index$1._render(result, state, options);
...
Index$1._render = function(__result, ctx, options) {
	__result.addComponent(Index$1);

	ctx = Object.assign({}, ctx);

	return `${(__result.head += `<title>Blog</title>`, "")}

<h1>Recent posts</h1>

<ul class="svelte-1frg2tf">
	${ each(ctx.posts, item => Object.assign({}, ctx, { post: item }), ctx => `
		<li><a rel="prefetch" href="blog/${escape(ctx.post.slug)}">${escape(ctx.post.title)}</a></li>`)}
</ul>`;
};

Index$1.css = {
	code: "ul.svelte-1frg2tf{margin:0 0 1em 0;line-height:1.5}",
	map: "{\"version\":3,\"file\":\"index.html\",\"sources\":[\"index.html\"],\"sourcesContent\":[\"<svelte:head>\\n\\t<title>Blog</title>\\n</svelte:head>\\n\\n<h1>Recent posts</h1>\\n\\n<ul>\\n\\t{#each posts as post}\\n\\t\\t<!-- we're using the non-standard `rel=prefetch` attribute to\\n\\t\\t\\t\\ttell Sapper to load the data for the page as soon as\\n\\t\\t\\t\\tthe user hovers over the link or taps it, instead of\\n\\t\\t\\t\\twaiting for the 'click' event -->\\n\\t\\t<li><a rel='prefetch' href='blog/{post.slug}'>{post.title}</a></li>\\n\\t{/each}\\n</ul>\\n\\n<style>\\n\\tul {\\n\\t\\tmargin: 0 0 1em 0;\\n\\t\\tline-height: 1.5;\\n\\t}\\n</style>\\n\\n<script>\\n\\texport default {\\n\\t\\tpreload({ params, query }) {\\n\\t\\t\\treturn this.fetch(`blog.json`).then(r => r.json()).then(posts => {\\n\\t\\t\\t\\treturn { posts };\\n\\t\\t\\t});\\n\\t\\t}\\n\\t};\\n</script>\"],\"names\":[],\"mappings\":\"AAiBC,EAAE,eAAC,CAAC,AACH,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACjB,WAAW,CAAE,GAAG,AACjB,CAAC\"}"
};

Index$1.preload = preload;
...
Slug.filename = "/Users/korjanvanwieringen/Documents/GitHub/N/src/routes/blog/[slug].html";

Slug.data = function() {
	return {};
};

Slug.render = function(state, options = {}) {
	var components = new Set();
	...
	var result = { head: '', addComponent };
	var html = Slug._render(result, state, options);
...
Slug._render = function(__result, ctx, options) {
	__result.addComponent(Slug);

	ctx = Object.assign({}, ctx);

	return `${(__result.head += `<title>${escape(ctx.post.title)}</title>`, "")}

<h1>${escape(ctx.post.title)}</h1>
...
Slug.preload = preload$1;

var Nav = {};

Nav.filename = "/Users/korjanvanwieringen/Documents/GitHub/N/src/components/Nav.html";
...
Layout.css = {
	...
	map: "{\"version\":3,\"file\":\"_layout.html\",\"sources\":[\"_layout.html\"],\"sourcesContent\":[\"<Nav segment={child.segment}/>\\n\\n<main>\\n\\t<svelte:component this={child.component} {...child.props}/>\\n</main>\\n\\n<style>\\n\\tmain {\\n\\t\\tposition: relative;\\n\\t\\tmax-width: 56em;\\n\\t\\tbackground-color: white;\\n\\t\\tpadding: 2em;\\n\\t\\tmargin: 0 auto;\\n\\t\\tbox-sizing: border-box;\\n\\t}\\n</style>\\n\\n<script>\\n\\texport default {\\n\\t\\tcomponents: {\\n\\t\\t\\tNav: '../components/Nav.html'\\n\\t\\t}\\n\\t};\\n</script>\"],\"names\":[],\"mappings\":\"AAOC,IAAI,eAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,IAAI,CACf,gBAAgB,CAAE,KAAK,CACvB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACvB,CAAC\"}"
};

var Error$1 = {};

Error$1.filename = "/Users/korjanvanwieringen/Documents/GitHub/N/src/routes/_error.html";
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "blog", file: "blog/index.html", component: Index$1 }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "blog_$slug", file: "blog/[slug].html", component: Slug, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
